# -*- coding: utf-8 -*-
"""
Created on Tue Mar 26 12:03:44 2019
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 custom_multiclass_5.py train --dataset=dataset --weights=coco
    
    #Train a new model starting from pre-trained ImageNet weights
    python custom_multiclass.py train --dataset=dataset --weights=imagenet
...
COCO_WEIGHTS_PATH = "/home/luy1/Desktop/Mask_RCNN-master/mask_rcnn_coco.h5"

# Directory to save logs and model checkpoints, if not provided
# through the command line argument --logs
#DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR, "logs")
DEFAULT_LOGS_DIR = 'logs_2'
...
class BalloonDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        for a in annotations:
            ...
            polygons = [r['shape_attributes'] for r in a['regions']] #remove.values()

            class_names_str  = [r['region_attributes']['name'] for r in a['regions']]#remove .values()
            class_name_nums = []
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "part": #adjusted here
    ...
    def image_reference(self, image_id):
        ...
        info = self.image_info[image_id]
        if info["source"] == "part": #adjusted here
            return info["path"]
        else:
...
def train(model):
    ...
    model.train(dataset_train, dataset_val,
                ...
                epochs=10, #modify the number of epochs
                layers='heads')
